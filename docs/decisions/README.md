...
- [0012: Per-Item Calibration Partition](0012-per-item-calibration-partition.md) — Draft: calibration assignment is per annotation item (chunks for retrieval, records for grounding/generation); per-task inheritable fraction and absolute cap
